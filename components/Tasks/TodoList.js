...
export class TodoList extends Component {
   ...
   * @param reason      string
   * @param todo        object
   * @param index       autogenerated string
   */
   ...
   * @param direction   the direction of the sliding  string
   * @param id          id of the todo                autogenerated string
   * @param close       closing todo                  function
   */

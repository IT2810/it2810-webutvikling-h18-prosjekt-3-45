...
prioritet. Derfor utgikk disse fordi det ikke er nødvendig å implementere alt av ikke-kritisk funksjonalitet i en prototype. Det er en bug blant de issuene som ligger igjen, men den er på grunn av en åpen issue i NativeBase, som vi ikke har noe med. Vi har linket til den i issuen. I utgangspunktet pleier man å slette branches ved release, men vi har valgt å la noen branches ligge igjen for å vise måten vi har håndtert navngivning av brancher og issue tilknytning.
